export class DLActorGenerator extends FormApplication {
   static get defaultOptions() {
      ...
      options.template = 'systems/mothership-fr/templates/dialogs/actor-generator-dialog.html';
      options.width = 800;
   ...
   async popUpSkillOptions(skillPopupOptions) {
      ...
      for (let i = 0; i < skillPopupOptions.master_full_set; i++) {
         await this.showSkillDialog('systems/mothership-fr/templates/dialogs/actor-generator/actor-generator-skill-option-full-master-dialog.html');

      }
      for (let i = 0; i < skillPopupOptions.expert_full_set; i++) {
         await this.showSkillDialog('systems/mothership-fr/templates/dialogs/actor-generator/actor-generator-skill-option-full-expert-dialog.html');

      }
      for (let i = 0; i < skillPopupOptions.trained; i++) {
         await this.showSkillDialog('systems/mothership-fr/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Trained");

      }
      for (let i = 0; i < skillPopupOptions.expert; i++) {
         await this.showSkillDialog('systems/mothership-fr/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Expert");

      }
      for (let i = 0; i < skillPopupOptions.master; i++) {
         await this.showSkillDialog('systems/mothership-fr/templates/dialogs/actor-generator/actor-generator-skill-option-single-dialog.html', "Master");
            ...
            buttons: [
               {
                  ...
                  callback: (event, button, dialog) => {
                     let form = dialog.element.children[2].querySelector('form');
